...
public class ModBlockEntities {
    public static final BlockEntityType<ArceusBlockEntity> ARCEUS_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "arceus_block_be"),
    ...
    public static final BlockEntityType<GiratinaBlockEntity> GIRATINA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "giratina_block_entity"),
    ...
    public static final BlockEntityType<DialgaBlockEntity> DIALGA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "dialga_block_entity"),
    ...
    public static final BlockEntityType<PalkiaBlockEntity> PALKIA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "palkia_block_entity"),
    ...
    public static final BlockEntityType<ArticunoBlockEntity> ARTICUNO_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "articuno_block_entity"),
    ...
    public static final BlockEntityType<MoltresBlockEntity> MOLTRES_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "moltres_block_entity"),
    ...
    public static final BlockEntityType<ZapdosBlockEntity> ZAPDOS_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "zapdos_block_entity"),
    ...
    public static final BlockEntityType<CelebiBlockEntity> CELEBI_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "celebi_block_entity"),
    ...
    public static final BlockEntityType<HoohBlockEntity> HOOH_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "hooh_block_entity"),
    ...
    public static final BlockEntityType<LugiaBlockEntity> LUGIA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "lugia_block_entity"),
    ...
    public static final BlockEntityType<RaidBlockEntity> RAID_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "raid_block_entity"),
    ...
    public static final BlockEntityType<CloneBlockEntity> CLONE_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "clone_block_entity"),
    ...
    public static final BlockEntityType<CloneBlockEntity> TROPHY_BIG_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "trophy_big_entity"),
                    FabricBlockEntityTypeBuilder.create(CloneBlockEntity::new,
                            ModBlocks.TROPHY_BIG).build());

    public static final BlockEntityType<CloneBlockEntity> TROPHY_SMALL_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "trophy_small_entity"),
                    FabricBlockEntityTypeBuilder.create(CloneBlockEntity::new,
                            ModBlocks.TROPHY_SMALL).build());

    /*public static final BlockEntityType<BaudafelicidadeBlockEntity> FELICIDADE_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "felicidade_block_entity"),
    ...
    public static final BlockEntityType<BlackJackBlockEntity> BLACKJACK_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "blackjack_block_entity"),
    ...
    public static final BlockEntityType<ClassicBlockEntity> CLASSIC_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "classic_block_entity"),
    ...
    public static final BlockEntityType<CorridaBlockEntity> CORRIDA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "corrida_block_entity"),
    ...
    public static final BlockEntityType<DadosBlockEntity> DADOS_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "dados_block_entity"),
    ...
    public static final BlockEntityType<DardosBlockEntity> DARDOS_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "dardos_block_entity"),
    ...
    public static final BlockEntityType<DrumsBlockEntity> DRUMS_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "drums_block_entity"),
    ...
    public static final BlockEntityType<FoguetinhoBlockEntity> FOGUETINHO_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "foguetinho_block_entity"),
    ...
    public static final BlockEntityType<LoteriaBlockEntity> LOTERIA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "loteria_block_entity"),
    ...
    public static final BlockEntityType<PedraBlockEntity> PEDRA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "pedra_block_entity"),
    ...
    public static final BlockEntityType<PiramideBlockEntity> PIRAMIDE_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "piramide_block_entity"),
    ...
    public static final BlockEntityType<PokerBlockEntity> POKER_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "poker_block_entity"),
    ...
    public static final BlockEntityType<RoletaBlockEntity> ROLETA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "roleta_block_entity"),
    ...
    public static final BlockEntityType<StairsBlockEntity> STAIRS_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "stairs_block_entity"),
    ...
    public static final BlockEntityType<VelhaBlockEntity> VELHA_BLOCK_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(PlanetaItems.MOD_ID, "velha_block_entity"),
